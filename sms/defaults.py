...
ORIGINAL_SYNTHETIC_MIDIS_PATH = 'plagdet/data/synthetic_dataset/pairs/original'
PLAGIARISED_SYNTHETIC_MIDIS_PATH = 'plagdet/data/synthetic_dataset/pairs/plagiarised'
SYNTHETIC_PAIR_TRACKER_PATH = 'plagdet/data/synthetic_dataset/pairs/synthetic_pairs_tracker.csv'
SYNTHETIC_PAIR_METADATA_PATH = 'plagdet/data/synthetic_dataset/pairs/synthetic_pair_metadata.pkl'

# Vector databases

MUSIC_VAE_DB = "plagdet/data/vector_databases/musicvae_embeddings.db"
MUSIC_BERT_DB = "plagdet/data/vector_databases/musicbert_embeddings.db"
