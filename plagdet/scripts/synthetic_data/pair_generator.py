...
class MidiModifier:
    ...
    def shift_entire_midi_pitch(self, midi: MidiFile, semitone_shift: int) -> MidiFile:
        """
    ...
    def shift_selected_notes_pitch(self, midi: MidiFile, notes_to_change: List[Tuple[Note, int]]) -> MidiFile:
        """
    ...
    def change_note_durations(midi: MidiFile, notes_to_scale: List[Tuple[Note, int]]) -> MidiFile:
        """
        ...
        note_on_dict = {note_on_idx:scale for ((note_on_idx, note_off_idx), scale) in notes_to_scale}
    ...
    def change_tempo(midi: MidiFile, tempo: int) -> MidiFile:
        pass
