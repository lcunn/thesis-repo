...
from plagdet.scripts.data.process_cases.ai_prompts import GPT_SYSTEM_PROMPT
from plagdet.scripts.data.process_cases.mcir_page_parser import mcir_page_parser
